...
/**
 * This class is for the right side of the boss. For the functions you can refer to the boss class
 ...
 */
public class BossRight extends GameObject{
    int lives = 10;
    ...
    public BossRight(Vector2D pos, double radius) {
        super(pos, radius);
    }
